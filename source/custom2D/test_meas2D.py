...
if __name__ == "__main__":
	...
	make_setpoint_list([(-10, 10, 1000)], dummy_voltage_source, meas_ctrl)
	make_setpoint_list([(-20, 100, 4000)], sweep_number, meas_ctrl)
	...
	transfer_thread = threading.Thread(target=transfer_thread_func, args=(0.1,)) #A low transfer delay (high frequency), will cause more error on the plotting end, due to mismatch between setp_index and actual data,
