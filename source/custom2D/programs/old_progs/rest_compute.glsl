...
void main()
{
    ...
    //surrounding_store(ivec2(200, 100), vec4(0.0, 0.0, 1.0, 1.0));
    if (imageLoad(image, data_point_position_pixelized_fixed).b > 0.5)
    {
        //surrounding_store(ivec2(300, 100), vec4(0.0, 1.0, 0.0, 1.0));
        return;
    }
    imageStore(image, data_point_position_pixelized_fixed, vec4(1.0, 1.0, 1.0, 1.0));
    //surrounding_store(data_point_position_pixelized_fixed, vec4(1.0, 1.0, 1.0, 1.0));
    ...
    //surrounding_store(data_point_position_pixelized_fixed, data_point_not_nan_color);
