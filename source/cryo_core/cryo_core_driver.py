...
class CryoCore(qcodes.Instrument):
    ...
    def set_sample_temp(self, value):
        """WARNING!: The (minimum K, maximum K) temperatures you can input into this function are (6.5, 248). This is constrained by the Cryo Core calibration data."""
        min = 6.5 #min sample temperature limited by calibration data
        max = 248 #max sample temperature limited by calibration data
...
if __name__ == '__main__':
    ...
    my_cryo_core.sample_temperature.set(6.5)
