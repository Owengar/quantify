...
class PlotMonitor_pyqt(Instrument):
    ...
    def update(self, tuid: str = None):
        ...
        """
        #self._remote_plotmon.update(tuid, get_datadir())
        #return
        try:
    ...
    def tuids_append(self, tuid: str = None, append_right: bool = False):
        """
        ...
        """
        try:
            self._remote_plotmon.main_QtPlot.win.closed
        except:
            self.interrupt_procedure()
        self._remote_plotmon.queue.put(("tuids_append", (tuid, get_datadir(), append_right)))
