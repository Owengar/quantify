...
class Magnet(Device):
    ...
    def get_settled(self, max_error=None, setpoint=None) -> bool:
        """
        Returns whether field is settled with respect to setpoint. Settled requires all relative errors
        delta_B/B in "stabilitywindow" to be within an epsilon of +-max_error.
    ...
    def get_settling(self, max_error=None, setpoint=None) -> bool:
        """
        Returns whether field is settling with respect to setpoint. Settling requires at least one relative error
        delta_B/B in "stabilitywindow" to be within an epsilon of +-max_error.
    ...
    def max_error(self) -> float:
        """
        Reads allowed maximum relative error of magnet: abs(setpoint-field)/field < max_error.
        """
        return self.query_value('max_error')
    ...
    def max_error(self, max_error: float):
        """
        Sets allowed maximum relative error of magnet: abs(setpoint-field)/field < max_error..
        """
        self.set_value('max_error', max_error)
