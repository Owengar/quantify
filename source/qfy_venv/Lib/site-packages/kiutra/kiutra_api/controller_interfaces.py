...
import time
from kiutra.kiutra_api.api_client import Device
    ...
    def wait_stable(self):
        ...
        while True:
            try:
                ...
                raise Exception(f"Controller is not active anymore")
...
class TemperatureControl(TemperatureSetpointControl):
    ...
    def start_single_adr(self, setpoint: float, ramp: float, start_temperature: float = None,
        ...
        """
        return self.call_method('start_single_adr', setpoint=setpoint, ramp=ramp, start_temperature=start_temperature,
    ...
    def start_serial_adr(self, setpoint: float, ramp: float, start_temperature: float = None,
        ...
        return self.call_method('start_serial_adr', setpoint=setpoint, ramp=ramp, start_temperature=start_temperature,
                   setup_speed=setup_speed, init_hold=init_hold, pre_regenerate=pre_regenerate)
    ...
    def start_cadr(self, setpoint: float, ramp: float, start_temperature: float = None,
        ...
        Start countinuous adr operation.
        """
        return self.call_method('start_cadr', setpoint=setpoint, ramp=ramp, start_temperature=start_temperature,
    ...
    def start_heater_control(self, setpoint: float, ramp: float, start_temperature: float = None,
        ...
        """
        return self.call_method('start_heater_control', setpoint=setpoint, ramp=ramp, start_temperature=start_temperature,
    ...
    def start_control(self, **kwargs):
        ...
        """
        return self.call_method('start_control', **kwargs)
