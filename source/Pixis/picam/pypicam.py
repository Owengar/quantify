...
class PyPICAM():
    ...
    def configure_camera(self, T=-75, roi=[0,0,1024,1024,1,1]):
        ...
        Picam_SetParameterFloatingPointValue(self.camera, ctypes.c_int(PicamParameter_SensorTemperatureSetPoint), pi32f(-75.0))
    ...
    # PicamTriggerResponse_StartOnSingleTrigger     = 5
        ...
        Picam_SetParameterFloatingPointValue(self.camera, ctypes.c_int(PicamParameter_ExposureTime), pi32f(20))
    ...
    def set_int_time(self, int_time=20):
        ...
        Picam_SetParameterFloatingPointValue(self.camera, ctypes.c_int(PicamParameter_ExposureTime), pi32f(int_time))
